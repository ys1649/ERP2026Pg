...
//=========== END OF SYSTEM REPORT DECLARE =========
    ...
    procedure ExecuteFunction(Tfm:TFormErpClass);
...
procedure TFM_Main2.FormDestroy(Sender: TObject);
begin
  FormList.Free;
end;

procedure TFM_Main2.actShipExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_SHIP);
end;

procedure TFM_Main2.actPO_RecvExecute(Sender: TObject);
begin
  ExecuteFunction(Tfm_PoRecv);

end;

procedure TFM_Main2.actAP_PayExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_AP_PAY);

end;

procedure TFM_Main2.actAR_RecvExecute(Sender: TObject);
begin
  ExecuteFunction(Tfm_ar_recv);
end;

procedure TFM_Main2.actProductExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_PRODUCT);

end;

procedure TFM_Main2.actEmployeExecute(Sender: TObject);
begin
  ExecuteFunction(Tfm_employee);
end;

procedure TFM_Main2.actAdjustExecute(Sender: TObject);
begin
//   ProcessExecute('INV_Adjust.FUN '+USER+' '+pass,1,1);
end;

procedure TFM_Main2.actData_BackupExecute(Sender: TObject);
begin
//  ProcessExecute('Data_Backup.FUN '+USER+' '+pass);
end;

procedure TFM_Main2.actData_RestoreExecute(Sender: TObject);
var m:string;
begin
...
//  ProcessExecute('Data_Restore.FUN '+USER+' '+pass);

end;

procedure TFM_Main2.actSYS_PARAMExecute(Sender: TObject);
begin
//  ProcessExecute('SYS_PARAM.FUN '+USER+' '+pass,1,1);
end;

procedure TFM_Main2.actRep_AR_Recv_DetailExecute(Sender: TObject);
begin
  ShowSysReportQuery(sysinfo.AdoConnection,'AR_001',dbsType);

end;

procedure TFM_Main2.actRep_AR_Recv_Detail1Execute(Sender: TObject);
begin
  ShowSysReportQuery(sysinfo.AdoConnection,'AR_002',dbsType);
end;

procedure TFM_Main2.AddSysReport_ToMenu(MenuItem: TMenuItem;
  RptCode_Like: string);
var
    qry:TAdoQuery;
    mnu:TMenuItem;
...
procedure TFM_Main2.RptMenuClick(Sender: TObject);
var i:integer;
    rptCode:string;
    mnu:TMenuItem;
begin
...
procedure TFM_Main2.actACNT_CHANGE_YEARExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_CHANGE_YEAR.FUN '+USER+' '+pass);

end;

procedure TFM_Main2.actACNT_ACCOUNTExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_Account);
end;

procedure TFM_Main2.actACNT_JOURNALExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_Journal);

end;

procedure TFM_Main2.actACNT_RPT_ASSETExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_RPT_ASSET.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actACNT_RPT_DETAILExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_RPT_DETAIL.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actACNT_RPT_INCOME_STAEMENTExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_RPT_INCOME_STATEMENT.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actACNT_RPT_TBExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_RPT_TB.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actACNT_RPT_CASHExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_RPT_CASH.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actACNT_RPT_BALANCEExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_RPT_BALANCE.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actACNT_RPT_DAILYExecute(Sender: TObject);
begin
//  ProcessExecute('ACNT_RPT_DAILY.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actResetInvTransactionExecute(Sender: TObject);
begin
//  ProcessExecute('ResetInvTransaction.FUN '+USER+' '+pass,1,1);

end;

procedure TFM_Main2.actCarExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_CAR);
end;


procedure TFM_Main2.actCustomerExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_Customer);
end;


procedure TFM_Main2.actSupplierExecute(Sender: TObject);
begin
  ExecuteFunction(TFM_SUPPLIER);
end;
...
procedure TFM_Main2.ExecuteFunction(Tfm: TFormErpClass);
var fm:TForm_ERP;
    id:string;
    n:integer;
begin
...
procedure TFM_Main2.ActCloseAllExecute(Sender: TObject);
var i:integer;
    fm:TForm_ERP;
    id:string;
    EmptyFlag:boolean;
...
procedure TFM_Main2.WMFunctionClose(var msg: TMessage);
var n:integer;
begin
  n:=msg.WParam;
